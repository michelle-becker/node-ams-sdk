...
AzureMediaService.prototype._buildTaskXML = function ( options, inc ) {
  ...
  if ( options.encoding === 'Thumbnails' ){
    ...
    task = "<?xml version=\"1.0\" encoding=\"utf-8\"?><Thumbnail Size=\"{%Width%},{%Height%}\" Type=\"{%Yype%}\" Filename=\"{OriginalFilename}_{Size}_{ThumbnailTime}_{ThumbnailIndex}_{Date}_{Time}.{DefaultExtension}\"><Time Value=\"{%Value%}\""
